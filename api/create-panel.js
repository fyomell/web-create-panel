...
// Fungsi untuk menentukan RAM, Disk, dan CPU berdasarkan pilihan
...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (!userResponse.ok) {
            ...
            throw new Error(userData.errors ? userData.errors[0].detail : 'Gagal membuat user.');
        }
